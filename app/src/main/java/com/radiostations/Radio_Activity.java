...
public class Radio_Activity extends AppCompatActivity implements SearchView.OnQueryTextListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Objects.requireNonNull(responses).equals("")) {
            ...
            DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Online Radio").child("Nepal Radio");
            scoresRef.keepSynced(false);
            DatabaseReference jokeslinks = FirebaseDatabase.getInstance().getReference().child("Online Radio").child("Nepal Radio");
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try {
                        ...
                        if (Objects.requireNonNull(databaseLink).equals(databaseUrl)) {
                            fetchRadioData(databaseUrl, false);
                        } else {
                            fetchRadioData(databaseUrl, true);
                        }
