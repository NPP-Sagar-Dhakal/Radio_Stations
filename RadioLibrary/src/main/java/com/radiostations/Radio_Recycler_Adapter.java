...
public class Radio_Recycler_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Radio_Recycler_Adapter(Context context, List<RadioItems.NepalNews.NepaliRadios> radioItems) {
    ...
    void updateList(List<RadioItems.NepalNews.NepaliRadios> searchList) {
